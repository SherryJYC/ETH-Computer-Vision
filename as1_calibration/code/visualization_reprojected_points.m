...
hold on;
for n=1:NB_PTS
    plot(xy(1,n), xy(2,n), 'g+', 'MarkerSize', 10, 'LineWidth',2) % clicked points 
    plot(xy_projected(1,n), xy_projected(2,n), 'ro', 'MarkerSize', 10, 'LineWidth',2) % reprojected points
end
legend('clicked point','reprojected point')
hold off;
