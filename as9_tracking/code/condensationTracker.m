...
if strcmp(videoName, 'myOwnVideo')
...
meanStateAPriori = zeros(length(frameValues),state_length); % a priori mean state nx state_len
...
particles_w = repmat(1/params.num_particles, params.num_particles, 1); % start with uniform w
